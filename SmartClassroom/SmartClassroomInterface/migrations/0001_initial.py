# Generated by Django 3.0.2 on 2020-01-25 13:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('roomClassType', models.CharField(choices=[(1, 'Technology'), (2, 'Laboratory'), (3, 'External Env.')], default=(1, 'Technology'), max_length=15, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secBaseProg', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='SmartClassroomInterface.ProgramBranch')),
        ...
        migrations.CreateModel(
            name='CourseSchedule',
            fields=[
                ('courseSch_CourseCode', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='SmartClassroomInterface.CourseSet')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ClassRoomRefer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='RoomClassReference', to='SmartClassroomInterface.Classroom', to_field='roomClassReferrable')),
                ('ClassTypeRefer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='TypeClassReference', to='SmartClassroomInterface.Classroom', to_field='roomClassType')),
                ('CourseRefer', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='CourseAssociated', to='SmartClassroomInterface.CourseSchedule')),
                ('HandlerRefer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='HandlerAssociate', to='SmartClassroomInterface.CourseSchedule', to_field='courseSch_Handler')),
                ('SectionRefer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='StudentGroupAssociate', to='SmartClassroomInterface.SectionGroup', to_field='secSubReferrable')),
                ('TimeEndRefer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='TimeEndEvent', to='SmartClassroomInterface.CourseSchedule', to_field='courseSch_sched_startEnd')),
                ('TimeStartRefer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='TimeStartEvent', to='SmartClassroomInterface.CourseSchedule', to_field='courseSch_sched_startTime')),
            ],
        ),
    ]
