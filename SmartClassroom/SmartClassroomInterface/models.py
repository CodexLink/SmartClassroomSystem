...
class Classroom(models.Model):
    ...
    roomClassType = models.CharField(max_length=15, null=False, blank=False, unique=True, default=CourseSessionTypes[0], choices=CourseSessionTypes)
...
class SectionGroup(models.Model):
    ...
    secBaseProg = models.OneToOneField(ProgramBranch, primary_key=True, to_field="prog_code" ,null=False, blank=False, unique=True, on_delete=models.CASCADE)
...
class CourseSchedule(models.Model):
    courseSch_CourseCode = models.OneToOneField(CourseSet, primary_key=True, to_field="courseSts_Code", null=False, blank=False, unique=True, on_delete=models.CASCADE)
...
class ClassroomLogger(models.Model):
    ...
    ClassRoomRefer = models.ForeignKey(Classroom, null=False, blank=False, to_field="roomClassReferrable", related_name="RoomClassReference", on_delete=models.CASCADE)
    ClassTypeRefer = models.OneToOneField(Classroom, null=False, blank=False, to_field="roomClassType", related_name="TypeClassReference", on_delete=models.CASCADE)
    CourseRefer = models.OneToOneField(CourseSchedule, null=False, blank=False, to_field="courseSch_CourseCode", related_name="CourseAssociated", on_delete=models.CASCADE)
    SectionRefer = models.ForeignKey(SectionGroup, null=False, blank=False, to_field="secSubReferrable", related_name="StudentGroupAssociate", on_delete=models.CASCADE)
    HandlerRefer = models.ForeignKey(CourseSchedule, null=False, blank=False, to_field="courseSch_Handler", related_name="HandlerAssociate", on_delete=models.CASCADE)
    TimeStartRefer = models.ForeignKey(CourseSchedule, null=False, blank=False, to_field="courseSch_sched_startTime", related_name="TimeStartEvent", on_delete=models.CASCADE)
    TimeEndRefer = models.ForeignKey(CourseSchedule, null=False, blank=False, to_field="courseSch_sched_startEnd", related_name="TimeEndEvent", on_delete=models.CASCADE)