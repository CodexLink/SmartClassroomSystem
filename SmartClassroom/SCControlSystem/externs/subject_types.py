...
YearBatchClasses = ((1, '1st Year'), (2, '2nd Year'), (3, '3rd Year'),
...
CEAProgramCCode = (('ARch', 'Architecture'), ('CE', 'Civil Engineering'),
                   ('CpE', 'Computer Engineering'), ('EE',
...
SessionDaysClassification = (('Monday', 'Monday'), ('Tuesday', 'Tuesday'),
                             ('Wednesday', 'Wednesday'),
                             ('Thursday', 'Thursday'), ('Friday', 'Friday'),
                             ('Saturday', 'Saturday'), ('Sunday', 'Sunday'))

BuildingClassification = ((1, 'Building 1'), (2, 'Building 2'),
                          (3, 'Building 3'), (4, 'Building 4'),
                          (5, 'Building 5'), (6, 'Building 6'),
                          (7, 'Building 7'), (8, 'Building 8'),
                          (9, 'Building 9'), (10, 'PE CNTR 1'), (11,
                                                                 'PE CNTR 2'))

BuildingFloors = ((1, 'Ground Floor'), (2, '2nd Floor'), (3, '3rd Floor'),
                  (4, '4th Floor'), (5, '5th Floor'))

# ! Classroom Action Logs
ClassroomActionTypes = (
    ('Classroom was Opened by Toggle Lock.',
     'Classroom was Opened by Toggle Lock.'),  #0
    ('Classroom was Closed by Toggle Lock.',
     'Classroom was Closed by Toggle Lock.'),  #1
    ('Classroom was Opened by Fingerprint.',
     'Classroom was Opened by Fingerprint.'),  #2
    ('Classroom was Closed by Fingerprint.',
     'Classroom was Closed by Fingerprint.'),  #3
    ('Classroom Electricity was Turned On.',
     'Classroom Electricity was Turned On.'),  #4
    ('Classroom Electricity was Turned Off.',
     'Classroom Electricity was Turned Off.'),  #5
    ('Device was Reset by a Staff.', 'Device was reset by a Staff.'),  #6
    ('Classroom Access was set to Disabled.',
     'Classroom Access was set to Disabled.'),  #7
    ('Classroom Access was set to Enabled.',
     'Classroom Access was set to Enabled.'),  #8
    ('Unauthorized Device Reset Detected',
     'Unauthorized Device Reset Detected'),  #9
    ('Unauthorized Access Change Detected',
     'Unauthorized Access Change Detected'),  #10
...
'''
RoleDeclaredTypes = (("Project Owner", "Project Owner"),
                     ("Project Administrator", "Project Administrator"),
                     ("ITSO Administrator", "ITSO Administrator"),
                     ("ITSO Supervisor", "ITSO Supervisor"), ("Professor",
                                                              "Professor"))

# ! Group Name Definition based Human Roles, Unrelated to Model ATM.
GroupDefinitionRoles = ("Project Owners", "Project Administrators",
                        "ITSO Administrators", "ITSO Supervisors",
                        "Professors")

# ! Device Types Declaration
DevDeclarationTypes = (("Digital Device", "Digital Device"),
                       ("Analog Device", "Analog Device"), ("Security Device",
                                                            "Security Device"))
