...
class Classroom(models.Model):
    ...
    Classroom_AccessState = models.CharField(max_length=8, null=False, blank=False, verbose_name='Classroom Access State', help_text='The current state of the classroom. This is very different from classroom device status.', default='Disabled', choices=ClassroomAccessStates)
