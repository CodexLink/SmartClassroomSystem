...
urlpatterns = [
    ...
    path('register/', RegisterUserView.as_view(), name='new_user_view'),
    path('logs/',
         StaffActionsListView.as_view(),
         name='staff_action_logs_view'),
    ...
    path('classroom/schedule/',
         ...
         name='schedule_exclusive_view'),  # ! For teachers only.
    # ! Admin Only URLs
