    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Classroom_Type',
                 models.CharField(
                     choices=[('Technological Only', 'Technological Only'),
                              ('Laboratory Only', 'Laboratory Only'),
                              ('External Only', 'External Only'),
                              ('Technological and Laboratory',
                               'Technological and Laboratory'),
                              ('Technological and External',
                               'Technological and External'),
                              ('Laboratory and Technological',
                               'Technological and Laboratory'),
                              ('Laboratory and External',
                               'External and Laboratory')],
                     default=('Technological Only', 'Technological Only'),
                     help_text='The type of the classroom.',
                     max_length=29,
                     validators=[
                         django.core.validators.MinLengthValidator(13),
                         django.core.validators.MaxLengthValidator(29)
                     ],
                     verbose_name='Classroom Instructure Type')),
                ('Classroom_State',
                 models.CharField(
                     choices=[('In-Use', 'In-Use'), ('Unlocked', 'Unlocked'),
                              ('Locked', 'Locked')],
                     default='Locked',
                     help_text=
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('ProgramBranch_Code',
                 models.CharField(
                     help_text=
                     'Declare the program code in shortest way possible',
                     max_length=20,
                     primary_key=True,
                     serialize=False,
                     unique=True,
            ...
            fields=[
                ...
                ('avatar',
                 models.ImageField(
                     blank=True,
                     null=True,
                     upload_to=SCControlSystem.models.user_avatar_path)),
                ('dept_residence',
                 models.ForeignKey(
                     blank=True,
                     help_text=
                     ...
                     to='SCControlSystem.ProgramBranch',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Sens_Name',
                 models.CharField(
                     help_text=
                     'Please indicate. We need to know what kind of sensors is it gonna be to communicate with the app.',
                     max_length=100,
                     validators=[
                         django.core.validators.MinLengthValidator(5),
                         django.core.validators.MaxLengthValidator(100)
                     ],
                     verbose_name='Sensors Name')),
                ('Sens_Type',
                 models.CharField(
                     choices=[('Digital Device', 'Digital Device'),
                              ('Analog Device', 'Analog Device'),
                              ('Security Device', 'Security Device')],
                     default=('Digital Device', 'Digital Device'),
                     help_text=
                     'The type of the sensors. This needs to be indicated to properly identify what kind of output it returns.',
                     max_length=29,
                     validators=[
                         django.core.validators.MinLengthValidator(13),
                         django.core.validators.MaxLengthValidator(15)
                     ],
                     verbose_name='Sensors Type')),
                ('Sens_Output',
                 models.CharField(
                     help_text=
                     'The output of the sensors can be a string, integer, float, or boolean.',
                     max_length=255,
                     verbose_name='Sensors Referred Output')),
                ('Sens_Date_Committed',
                 models.DateTimeField(
                     auto_now_add=True,
                     help_text=
                     'The date and time from where the the output of the sensors is committed. ',
                     verbose_name='Sensors Date Committed')),
                ('Sens_Ref',
                 models.ForeignKey(
                     help_text='Indication of where the data comes from.',
                     on_delete=django.db.models.deletion.CASCADE,
                     to='SCControlSystem.DeviceInfo',
                     to_field='Device_Unique_ID',
                     verbose_name='Sensors Unique Reference')),
            ],
            options={
                ...
                ('Section_SubUniqueGroup',
                 models.CharField(
                     choices=[
                         ...
                         ('FA4', 'FA4'), ('FA5', 'FA5'), ('FA6', 'FA6'),
                         ('FA7', 'FA7'), ('FA8', 'FA8'), ('FA9', 'FA9'),
                         ('FB1', 'FB1'), ('FB2', 'FB2'), ('FB3', 'FB3'),
                         ('FB4', 'FB4'), ('FB5', 'FB5'), ('FB6', 'FB6'),
                         ('FB7', 'FB7'), ('FB8', 'FB8'), ('FB9', 'FB9'),
                         ('FC1', 'FC1'), ('FC2', 'FC2'), ('FC3', 'FC3'),
                         ('FC4', 'FC4'), ('FC5', 'FC5'), ('FC6', 'FC6'),
                         ('FC7', 'FC7'), ('FC8', 'FC8'), ('FC9', 'FC9')
                     ],
                     help_text=
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CourseSchedule_Section',
                 models.ForeignKey(
                     blank=True,
                     help_text=
                     'Refers to a section who partakes to this course.',
                     null=True,
                     on_delete=django.db.models.deletion.CASCADE,
                     to='SCControlSystem.SectionGroup',
                     verbose_name='Section Course Assignment')),
                ('CourseSchedule_Unique_ID',
                 models.OneToOneField(
                     blank=True,
                     help_text=
                     'A Unique Identifier for the course schedule. Required for the unique identity which will be referenced later.',
                     max_length=32,
                     null=True,
                     on_delete=django.db.models.deletion.CASCADE,
                     to='SCControlSystem.Classroom',
                     to_field='Classroom_Unique_ID',
                     verbose_name='Course Schedule Unique ID')),
            ],
            options={
                'verbose_name':
                'Enlisted Course Schedule',
                'db_table':
                'enlisted_course_scheds',
                'permissions':
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Course_Reference',
                 models.ForeignKey(
                     help_text=
                     'The course with its schedule referenced into one.',
                     on_delete=django.db.models.deletion.CASCADE,
                     to='SCControlSystem.CourseSchedule',
                     verbose_name='Schedule Instance Reference')),
            ],
            options={
                'verbose_name':
                'Classroom Recent Log',
                'db_table':
                'classroom_action_logs',
                'permissions':
