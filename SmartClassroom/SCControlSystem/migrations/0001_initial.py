    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Classroom_Name', models.CharField(max_length=50, validators=[django.core.validators.MinLengthValidator(5), django.core.validators.MaxLengthValidator(50)], verbose_name='Classroom Name')),
                ('Classroom_Building', models.PositiveIntegerField(choices=[(1, 'Building 1'), (2, 'Building 2'), (3, 'Building 3'), (4, 'Building 4'), (5, 'Building 5'), (6, 'Building 6'), (7, 'Building 7'), (8, 'Building 8'), (9, 'Building 9'), (10, 'PE CNTR 1'), (11, 'PE CNTR 2')], default=(1, 'Building 1'), verbose_name='Classroom Building Assignment')),
                ('Classroom_Floor', models.PositiveIntegerField(choices=[(1, 'Ground Floor'), (2, '2nd Floor'), (3, '3rd Floor'), (4, '4th Floor'), (5, '5th Floor')], default=(1, 'Ground Floor'), verbose_name='Classroom Floor Assignment')),
                ('Classroom_Number', models.PositiveIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(29)], verbose_name='Classroom Number')),
        ...
        migrations.CreateModel(
            name='Course',
            fields=[
                ('Course_Name', models.CharField(help_text='Please indicate. We need to know what type of room is it gonna be.', max_length=100, validators=[django.core.validators.MinLengthValidator(5), django.core.validators.MaxLengthValidator(100)])),
                ('Course_Code', models.CharField(help_text='Provide Course Code with Probable In Relation to Course itself.', max_length=10, primary_key=True, serialize=False, unique=True, validators=[django.core.validators.MinLengthValidator(4), django.core.validators.MaxLengthValidator(10)])),
                ('Course_Units', models.PositiveIntegerField(help_text='Units is indenpendent and user should know it based on lecture time and classroom type to use.', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(6)])),
                ('Course_Capacity', models.PositiveIntegerField(default=15, help_text='The number of students that can included in the class. Minimum is 15 and Maximum is 45', validators=[django.core.validators.MinValueValidator(15), django.core.validators.MaxValueValidator(60)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CourseSchedule_Session_Start', models.TimeField(blank=True, help_text='Refers to a time start session point.', null=True, unique=True, verbose_name='Course Session Start Time')),
                ('CourseSchedule_Session_End', models.TimeField(blank=True, help_text='Refers to a time end session point.', null=True, verbose_name='Course Session End Time')),
