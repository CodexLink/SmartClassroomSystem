# Generated by Django 3.0.3 on 2020-02-12 08:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Device_Status', models.CharField(choices=[('Operational', 'Operational'), ('In-Use', 'In-Use'), ('Opened', 'Opened'), ('Closed', 'Closed'), ('Non-Operational', 'Non-Operational')], default='Non-Operational', help_text='Status Indication of the device. Required. Basically this must match from the classroom status that is currently assigned with.', max_length=15, validators=[django.core.validators.MinLengthValidator(6), django.core.validators.MaxLengthValidator(15)], verbose_name='Device Status')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CourseSchedule_Section', models.OneToOneField(blank=True, help_text='Refers to a section who partakes to this course.', null=True, on_delete=django.db.models.deletion.CASCADE, to='SCControlSystem.SectionGroup', verbose_name='Section Course Assignment')),
            ],
            options={
