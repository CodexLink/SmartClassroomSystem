# Generated by Django 3.0.2 on 2020-02-02 03:43
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Common_ID', models.CharField(default='PJ3cWnhZ1kx64D9yOYq18msor6eGLbE1', max_length=32, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CourseSchedule_Session_Start', models.TimeField(blank=True, null=True, unique=True)),
                ('CourseSchedule_Session_End', models.TimeField(blank=True, null=True)),
                ...
                ('CourseSchedule_Instructor', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, to_field='Common_ID')),
                ('CourseSchedule_Room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='ClassRoomMainReference', to='SCControlSystem.Classroom', to_field='Classroom_CompleteString')),
            ],
        ),
        migrations.CreateModel(
