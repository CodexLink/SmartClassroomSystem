...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='CourseSchedule',
            fields=[
                ('CourseSchedule_CourseCode', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, primary_key=True, serialize=False, to='SC_ControlSystem.Course')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commonId', models.CharField(default='ikSHZUZctqYGZYybqTYd3JWnYsC2sciA', max_length=32)),
                ('role', models.CharField(choices=[('ITSO Administrator', 'ITSO Administrator'), ('ITSO Assitant Administrator', 'ITSO Assitant Administrator'), ('ITSO Supervisor', 'ITSO Supervisor'), ('Department Staff', 'Department Staff'), ('Teacher Staff', 'Teacher Staff'), ('Student Staff', 'Student Staff')], default=('ITSO Administrator', 'ITSO Administrator'), max_length=27)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Section_Program', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='SC_ControlSystem.ProgramBranch')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ClassRoom_Reference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='RoomClassReference', to='SC_ControlSystem.Classroom', to_field='Classroom_CompleteString')),
                ('Section_Reference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='StudentGroupAssociate', to='SC_ControlSystem.SectionGroup', to_field='Section_CompleteStringGroup')),
                ('ClassInstructor_Reference', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='InstructorAssociate', to='SC_ControlSystem.CourseSchedule', to_field='CourseSchedule_Instructor')),
                ('Course_Reference', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='CourseAssociated', to='SC_ControlSystem.CourseSchedule')),
            ],
        ),
    ]
